...
$.each(data, function(index, value) {
    ...
    if (value.State == "California" | value.State == "Florida" | value.State == "Illinois" | value.State == "Texas" | value.State == "South Carolina" | value.State == "New York" | value.State == "Washington") {}else{
